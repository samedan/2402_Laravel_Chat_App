 ...
 <div class="container py-md-5 container--narrow">
  <h2>
    <img class="avatar-small" src="{{$sharedData['avatar']}}" /> {{$sharedData['username']}}
     ...
     {{-- BUTTON to Follow --}}
      @auth
      @if(!$sharedData['currentlyFollowing']   // you are not currently following user 
          AND
          auth()->user()->username != $sharedData['username'] // this is not you 'UserController'
      )   
  ...
  <div class="profile-nav nav nav-tabs pt-2 mb-4">
   {{-- The third segment in the url /profile/dan/>>following<< --}}
