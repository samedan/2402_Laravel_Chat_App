...
<html lang="en">
  ...
  <body>
   ...
   @auth
    <div data-username="{{auth()->user()->username}}" data-avatar="{{auth()->user()->avatar}}" class="chat-wrapper shadow border-top border-left" id="chat-wrapper">
